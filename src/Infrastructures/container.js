...
const EmployeRepositoryPostgres = require('./repository/EmployeRepositoryPostgres');
...
container.register([
  ...
  {
    key: EmployeRepository.name,
    Class: EmployeRepositoryPostgres,
    parameter: {
      dependencies: [
        {
          concrete: pool,
...
container.register([
  ...
  {
    key: AddEmployeUseCase.name,
    Class: AddEmployeUseCase,
    parameter: {
      injectType: 'destructuring',
      dependencies: [
        {
          name: 'employeRepository',
          internal: EmployeRepository.name,
        },
        {
          name: 'authenticationTokenManager',
          internal: AuthenticationTokenManager.name,
  ...
  {
    key: GetEmployeByIdUseCase.name,
